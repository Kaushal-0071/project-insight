...
const genAI = new GoogleGenerativeAI(apiKey);
      ...
      history: [
        {
          role: "user",
          parts: [{
            text: `Here is a file: ${filePath}\n${content}\n\nPlease update this code with improvements, fixes, and optimizations while keeping the structure and functionality intact.`
          }],
        }
      ],
    });
  ...
  app.post('/update', async (req, res) => {
    try {
      ...
      console.log("...........................................................................................");
     //console.log(updates);
      res.json({ message: "Updates applied successfully", updates ,filesText});
    } catch (error) {
